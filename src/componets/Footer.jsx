    ...
    return (
        <div className="global">
            ...
            <div className="max-w-[1400px] flex justify-center items-center flex-col">
                ...
                <div className=" footer flex w-[50%] text-center justify-center items-center gap-[40px] m-[20px]">
                    <a alt="img" href="https://www.linkedin.com/in/bharatk41/"  target="_blank">
                        <img src={Linkedin3} alt="img-linkedin" className="footer-img  w-[60px] sm:w-48 md:w-32 "/>
                    </a>
                    <a href="https://www.youtube.com/channel/UCrPdqiHVWaw92sVO3AEW9yw"  target="_blank">
                        <img src={youtube3} alt="img-youtube" className="footer-img  w-[60px] sm:w-48  md:w-32 " />
                    </a>
                    <a href=""  target="_blank">
                        <img src={Instagram3} alt="img-instagram"  className="footer-img  w-[60px] sm:w-48  md:w-32"/>
                    </a>
                    <a href="https://twitter.com/Bharatp2004" target="_blank">
                        <img src={twitter} alt="twitter-img" className="footer-img  w-[30px] sm:w-32  md:w-16"/>
                    </a>
                    <a href="https://discord.com/channels/@me" target="_blank">
                        <img src={discord} alt="discord-img" className="footer-img w-[60px] sm:w-48  md:w-32 "/>
                    </a>
                </div>
